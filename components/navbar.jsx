...
import { Menu, X, Search, User, LogOut, Briefcase } from "lucide-react";
...
export default function NexoraNavbar() {
  ...
  return (
    <header className={`fixed w-full z-50 transition-all duration-500 ${isScrolled ? 'bg-black/90 backdrop-blur-md border-b border-gray-800' : 'bg-black/80 backdrop-blur-md border-b border-gray-900'}`}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          {/* Logo */}
          <a href="/" className="group">
            <span className="text-xl font-light text-white tracking-tight group-hover:text-amber-500 transition-colors">NEXORA</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-6">
            <div className="relative group">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="pl-10 pr-4 py-2 w-56 bg-gray-900/50 text-white placeholder-gray-600 rounded-none border border-gray-800 focus:outline-none focus:border-amber-500/50 text-sm font-light tracking-wide transition-all"
              />
            </div>
            ...
            {user ? (
              <div className="flex items-center gap-4">
                ...
                >
                  ...
                  <span className="font-light text-white text-sm tracking-wide">Dashboard</span>
                </a>
                <button
              ...
              {user ? (
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div>
                      <div className="font-light text-white">Dashboard</div>
                      <div className="text-xs text-gray-600 font-light">View portfolio</div>
                    </div>
                  </a>
                  <button
                    onClick={handleLogout}
                ...
                <div className="space-y-3">
                  ...
                  <button className="w-full bg-amber-500 text-black py-3 font-light tracking-wide hover:bg-amber-400 transition-all">
                    Get Started
                  </button>
                </div>
              )}
